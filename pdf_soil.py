...
class Pdf_soil():
  def Sieve_PDF(self, form_data, datos, yu):
    ...
    pdf.image('fk1.png', x = 10, y = 180, w = 20, h = 20, type = 'PNG')
    pdf.image('fk2.png', x = 30 + 5 , y = 180, w = 20, h = 20, type = 'PNG')
    pdf.image('fk3.png', x = 50 + 10 , y = 180, w = 20, h = 20, type = 'PNG')
  ...
  def Plast_PDF(self, form_data, datos_pl, yu):
      ...
      pdf.image('fk1.png', x = 10, y = 267, w = 20, h = 20, type = 'PNG')
      pdf.image('fk2.png', x = 30 + 5 , y = 267, w = 20, h = 20, type = 'PNG')
      pdf.image('fk3.png', x = 50 + 10 , y = 267, w = 20, h = 20, type = 'PNG')
